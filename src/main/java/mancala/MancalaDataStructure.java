...
public class MancalaDataStructure implements Serializable{
    ...
    /**
     * The function returns the current position of the iterator.
     * 
     * @return The method is returning the value of the variable "iteratorPos".
     */
    protected int getIteratorPos(){
        return iteratorPos;
    } 
}
